...
import com.review.wiki.error.ServiceRuntimeException;
import com.review.wiki.error.UnauthorizedException;
import com.review.wiki.model.api.response.ApiResult;

import static com.review.wiki.model.api.response.ApiResult.ERROR;

@ControllerAdvice
public class GeneralExdceptionHandler {
	...
	@ExceptionHandler({ IllegalStateException.class, IllegalArgumentException.class, TypeMismatchException.class,
			HttpMessageNotReadableException.class, MissingServletRequestParameterException.class,
			MultipartException.class, JSONException.class })
